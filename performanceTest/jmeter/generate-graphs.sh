...
java -jar $GRAPH_GENERATOR_LOCATION --tool Reporter --generate-csv aggregate_report.log --input-jtl $LOGFILE --plugin-type AggregateReport > /dev/null 2>&1
